  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden bg-paper-alt">
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-brass/10 via-paper/5 to-transparent"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10 w-full flex flex-col items-center text-center pt-10">
        ...
        >
          <span className="inline-block py-1 px-3 rounded-full border border-brass/30 bg-brass/10 text-brass text-sm font-mono mb-6 uppercase tracking-widest">
            Advocacia Especializada
          </span>
          <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-medium text-ink leading-tight mb-6 max-w-4xl">
            Soluções jurídicas com <span className="text-brass italic">clareza</span> e <span className="text-brass italic">eficiência</span>.
          </h1>
        ...
        <motion.div
          ...
          className="mt-20 w-full max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-8 py-8 border-y border-brass/20"
        >
          <div className="flex flex-col items-center gap-2">
            <span className="font-display text-4xl md:text-5xl text-brass">4000+</span>
            <span className="font-sans text-sm uppercase tracking-widest text-graphite/70 font-bold">Atendimentos</span>
          </div>
          <div className="hidden md:block w-px h-full bg-brass/20 mx-auto"></div>
          <div className="flex flex-col items-center gap-2">
            <span className="font-display text-4xl md:text-5xl text-brass">5000+</span>
            <span className="font-sans text-sm uppercase tracking-widest text-graphite/70 font-bold">Consultas</span>
          </div>
          <div className="hidden md:block w-px h-full bg-brass/20 mx-auto"></div>
          <div className="flex flex-col items-center gap-2">
            <span className="font-display text-4xl md:text-5xl text-brass">33+</span>
